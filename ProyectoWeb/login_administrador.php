...
<html >
  ...
  <body >
        ...
        <!-- Formulario de login -->
     <div class="form">
      <h1>GAMERS<span>.ES</span> ADMIN</h1>
      <form role="form" action="/login" method="POST" name="login" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" autocomplete="off">
        <div class="field-wrap">
          <div class="form-group input-group"><span id="basic-addon1" class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
            <input type="text" id="user-admin" name="username" placeholder="Username" aria-describedby="basic-addon1" class="form-control" />
          </div>
        </div>
        ...
        <div class="field-wrap">
          <div class="form-group input-group"><span id="basic-addon2" class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
            <input type="password" id="pass-admin" name="password" placeholder="Password" aria-describedby="basic-addon2" autocomplete="off" class="form-control" />
          </div>
        </div><br>
        <p class="forgot"><a href="/forgot">olvidaste tu contraseña?</a></p>
        <button type="button" class="btn btn-danger button button-block" onclick="logInAdmin()">Acceder</button>
      </form>
    </div><!-- fin log in  -->
